...
class TestTable(unittest.TestCase):
    ...
    def test_read_row_custom_retry(self):
        from api_core.google.api_core.retry import Retry
        from api_core.google.api_core.retry import if_exception_type
        from bigtable.google.cloud.bigtable.table import _BigtableRetryableError
